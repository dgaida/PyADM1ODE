...
def main() -> None:
    ...
    ammonia_sensor = ChemicalSensor(
        ...
        accuracy=0.01,
        drift_rate=0.002,
        sample_interval=3.0 / 24.0,
        measurement_delay=1.0 / 24.0,
    ...
    nitrogen_sensor = ChemicalSensor(
        ...
        accuracy=6.0,
        drift_rate=2.0,
        sample_interval=6.0 / 24.0,
        measurement_delay=3.0 / 24.0,
        detection_limit=5.0,
        unit="mg/L",
