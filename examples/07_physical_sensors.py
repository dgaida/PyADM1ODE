...
def main() -> None:
    ...
    flow_sensor = PhysicalSensor(
        ...
        accuracy=0.05,
        drift_rate=0.01,
        response_time=10.0 / 86400,
        sample_interval=1.0 / 1440,
        unit="m3/d",
    ...
    ph_sensor = PhysicalSensor(
        ...
        accuracy=0.01,
        drift_rate=0.005,
        response_time=60.0 / 86400,
        sample_interval=10.0 / 1440,
        unit="pH",
