...
The PyADM1ODE implementation requires C# DLLs for substrate characterization.

Source code to create the DLL files can be found at [matlab_toolboxes](https://github.com/dgaida/matlab_toolboxes).

The API documentation of the DLL files can be found at [matlab_toolboxes/docs](https://github.com/dgaida/matlab_toolboxes/tree/master/docs/biogas_csharp/api_documentation).
