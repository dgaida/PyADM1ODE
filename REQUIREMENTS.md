...
- **NFA-1.2: Parallelisierungseffizienz**
  Der `ParallelSimulator` muss eine nahezu lineare Skalierung mit der Anzahl der physischen CPU-Kerne aufweisen, um大規模 Parametersuchen effizient zu bewältigen.
