...
# 50 t/d maize silage (solid feeder) + 10 m3/d cattle slurry (pre-pit) into F1.
# Slot 0 = maize silage, slot 1 = cattle slurry.
...
# V_liq = pi/4 * D^2 * fill_fraction * H_wall; Q_substrates [m3/d] per slot.
cfg.add_digester("F1", V_liq=2244, V_gas=549, T_ad=313.15, name="Fermenter 1", Q_substrates=[50, 10])
cfg.add_digester("N1", V_liq=2244, V_gas=549, T_ad=313.15, name="Nachgaerer")
cfg.add_digester("G1", V_liq=3817, V_gas=924, T_ad=293.15, name="Gaerrestlager")
